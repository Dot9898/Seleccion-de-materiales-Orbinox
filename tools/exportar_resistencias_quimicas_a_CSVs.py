...
wb = load_workbook(DATA_PATH / 'resistencias_quimicas.xlsx', data_only=True)
ws = wb.active

#arreglar conversión pdf a excel
with (open(DATA_PATH / 'values.csv', "w", newline="", encoding="utf-8") as f_values, 
      open(DATA_PATH / 'colors.csv', "w", newline="", encoding="utf-8") as f_colors):
